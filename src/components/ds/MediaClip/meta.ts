...
export default defineMeta({
  ...
  props: [
    ...
    },
    {
      ...
      description:
        "Clip name chip pinned to the top-left, clamped to 70% of the clip width.",
    },
    {
      name: "duration",
      type: "React.ReactNode",
      description:
        "Tabular mono duration chip pinned to the top-right corner.",
    },
    {
      name: "caption",
      type: "React.ReactNode",
    ...
    },
    {
      ...
      type: "string",
      description:
        "Class overrides for the root (h-full min-w-[200px]; position it from the lane).",
    },
  ],
  status: "stable",
