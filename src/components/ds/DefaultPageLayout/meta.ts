  ...
  props: [
    {
      ...
      description:
        "Page sections rendered in the scrolling white column; each child is responsible for its own width (w-full) since the column aligns items to the start.",
    },
    {
      name: "className",
      type: "string",
