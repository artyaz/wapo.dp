  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        dir={dir}
        className={cn(
          // Praxis geometry: popover content is a floating *panel* → 8px radius
          // (--ds-radius-lg via rounded-lg), matching Dialog/Command panels;
          // shadow is allowed here as a true overlay surface.
