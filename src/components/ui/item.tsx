...
// Praxis: calm transitions — color only, 150ms default (never shadows/hue).
...
function Item({
  ...
  // Base-UI-style `render` prop: the provided element replaces the root,
  // receives the merged className/props, and Item's children are hoisted
  // into it (render children are preserved when Item has none).
  if (render) {
    const renderProps = {
      ...props,
      "data-slot": "item",
    ...
    return children !== undefined
      ? React.cloneElement(render, renderProps, children)
