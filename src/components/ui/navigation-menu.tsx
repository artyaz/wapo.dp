...
const navigationMenuTriggerStyle = cva(
  // transition-colors only — Praxis forbids animating box-shadow (focus ring)
...
function NavigationMenuLink({ render, children, className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Link> &
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        // data-active (presence) — Radix Link emits data-active="" when the
        // `active` prop is set; data-[active=true] would never match it.
