...
export function QuestionnaireDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={<Button variant="outline">Open clarification</Button>} />
      <DialogContent>
        <Questionnaire
          defaultItem="scope"
          items={items}
        ...
        >
          <QuestionnaireItem name="scope" required>
            <DialogHeader>
              <QuestionnaireProgress />
              <QuestionnaireTitle render={<DialogTitle>Which files are in scope?</DialogTitle>} />
              <QuestionnaireDescription render={<DialogDescription>Choose how broadly the agent can update the workspace.</DialogDescription>} />
            </DialogHeader>
            <QuestionnaireChoices>
          ...
          <QuestionnaireItem name="tests" required>
            <DialogHeader>
              <QuestionnaireProgress />
              <QuestionnaireTitle render={<DialogTitle>How much verification is needed?</DialogTitle>} />
              <QuestionnaireDescription render={<DialogDescription>Choose the checks the agent should run before handoff.</DialogDescription>} />
            </DialogHeader>
            <QuestionnaireChoices>
