...
export function EmptyRtl() {
  ...
  return (
    <Empty dir={dir}>
      ...
      <Button variant="link" className="text-muted-foreground" size="sm" render={<a href="#">{t.learnMore}{" "}<ArrowUpRightIcon className="rtl:rotate-270" data-icon="inline-end" /></a>} />
    </Empty>
  )
}
