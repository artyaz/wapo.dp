...
export function DropdownMenuRtl() {
  ...
  return (
    // `dir` lives on the DropdownMenu root — Radix propagates it to the
    // content and all sub-menu content elements.
    <DropdownMenu dir={dir}>
      <DropdownMenuTrigger render={<Button variant="outline">{t.open}</Button>} />
      <DropdownMenuContent
