...
export const COMPONENT_REGISTRY: RegistryEntry[] = [
  ...
  { name: "ReasoningLog", slug: "reasoning-log", category: "data-display" },
...
const META_LOADERS: Record<string, () => Promise<{ default: ComponentMeta }>> = {
  ...
  ReasoningLog: () => import("@/components/ds/ReasoningLog/meta"),
...
const DEMO_LOADERS: Record<string, () => Promise<DemoModule>> = {
  ...
  ReasoningLog: () => import("@/components/ds/ReasoningLog/demo"),
